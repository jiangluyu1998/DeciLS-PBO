...
public:
	...
	long long *clause_max_weight;// added by jly
	int *clause_max_weight_id;// added by jly
	long long *clause_sum_weight;//add by jly: sum of coff. of clauses
	...
	int *sat_count;
	int *unsat_count;//added by jly 20221025
