...
class Decimation
{
  public:
    ...
    void free_memory();
    void init(int *ls_local_opt, int *ls_global_opt, lit *ls_unit_clause, int ls_unit_clause_count, int *ls_clause_lit_count,  int *ls_clause_sum_lit_weight, int *ls_clause_max_lit_weight, int *ls_clause_max_lit_weight_id, int *ls_clause_cardinality);
    ...
    int *clause_max_lit_weight;
    int *clause_sum_lit_weight;
...
void Decimation::make_space(int max_c, int max_v)
{
    ...
    clause_max_lit_weight=new int[max_c];
    clause_sum_lit_weight=new int[max_c];
...
void Decimation::init(int *ls_local_opt, int *ls_global_opt, lit *ls_unit_clause, int ls_unit_clause_count, int *ls_clause_lit_count, int *ls_clause_sum_lit_weight, int *ls_clause_max_lit_weight, int *ls_clause_max_lit_weight_id, int *ls_clause_cardinality)
{
    int v;
